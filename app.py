...
st.set_page_config(page_title="Equation Solver", page_icon="math.png",initial_sidebar_state="auto")
...
with st.sidebar:
    ...
    st.markdown("<p style='text-align: center; font-size: 1.2em; color: white;'><a href='https://www.linkedin.com/in/sgvkamlakar'>Source Code</a></p>", unsafe_allow_html=True)
